...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[var(--color-primary)] rounded-full blur-[128px] opacity-15" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[var(--color-secondary)] rounded-full blur-[128px] opacity-10" />
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-[var(--color-bg-elevated)] border border-[var(--color-border)] text-white placeholder:text-[var(--color-text-muted)] focus:outline-none focus:border-[var(--color-primary)] transition-colors text-sm"
              required
            />
          </div>
          <div>
        ...
        <p className="text-center text-sm text-[var(--color-text-muted)] mt-6">
          ...
          <Link href="/signup" className="text-[var(--color-primary-light)] hover:text-white transition-colors">
            Sign up free
          </Link>
        </p>
      </motion.div>
